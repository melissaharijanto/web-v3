...
const ExperienceComponent: React.FC<Experience> = ({
  ...
  return (
    <div className="bg-experience bg-cover bg-opacity-25 flex flex-col items-center border-black border-[1px] rounded-bl-xl rounded-tr-xl shadow-project p-6 md:px-14 lg:px-18 w-full">
      {exp.image ? (
        <div className="mb-4">
          <img
            src={exp.image}
