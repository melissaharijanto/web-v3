...
const HeroComponent = () => {
  return (
    <div
      className={`bg-light-background bg-cover w-full min-h-[80vh] flex flex-col justify-center rounded-3xl border-[1px] border-black shadow-mobile lg:shadow-solid
